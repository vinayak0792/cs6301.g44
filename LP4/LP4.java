package cs6301.g44.LP4;

/**
 * The following program enumerates and counts all the topological sort, shortest paths between two nodes in a given graph. 
...
import cs6301.g44.LP4.Graph.Edge;
import cs6301.g44.LP4.Graph.Vertex;
...
public class LP4 {
	...
	// Helper function that checks for negative cycles and updates shortest
	// paths.
	private boolean bellmanFord(Vertex src) {
		for (Vertex v : g.v) {
	...
	public long countShortestPaths(Vertex t) {
		...
		topList = TopologicalOrdering.toplogicalOrder(g);
		int i = 0;
